    ...
    <div class="box-content">
        ...
        <div class="box-content-search">
            <div class="line-menu-search-category custom-shadow">
                ...
                <button class="btn-filter" data-bs-toggle="offcanvas" data-bs-target="#offcanvasFillter"
                        aria-controls="offcanvasFillter"><i class="fa-solid fa-filter"></i></button>
            </div>
            ...
            <div class="box-list-content py-3">
                <div class="content-search-sp">
                    @foreach($listData as $pro)
                        <a class="box-product-item" href="{{route('detail-product',$pro->slug)}}">
