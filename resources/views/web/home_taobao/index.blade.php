                ...
                <div class="box-category position-relative">
                    @foreach($categoryTaobao as $cate)
                        ...
                        <div class="sub-category">
                            ...
                            <a href="{{url('taobao/danh-muc/'.$cate->slug.'/'.$cate2->slug)}}" class="title-big-category">{{$cate2->name}}</a>
                            <div class="d-flex align-items-center flex-wrap mb-2">
                                @foreach($cate2->grandchildren as $cate3)
                                <a href="{{url('taobao/danh-muc/'.$cate->slug.'/'.$cate2->slug.'/'.$cate3->slug)}}" class="title-small-category">{{$cate3->name}}</a>
                                @endforeach
                            </div>
                                @endforeach
                        </div>
