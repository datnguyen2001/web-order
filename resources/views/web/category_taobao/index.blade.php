    ...
    <div class="box-content">
        ...
        <div class="box-list-content-category">
            <div class="box-content-category-left">
                <a href="{{route('taobao.category',$cate->slug)}}"
                ...
                <div class="box-left-item-menu">
                    @foreach($dataCategory as $cateTwo)
                        <div class="box-item-category-left">
                            <a href="{{url('taobao/danh-muc/'.$cate->slug.'/'.$cateTwo->slug)}}"
                            ...
                            <div class="box-item-menu-left">
                                @foreach($cateTwo->categoryThree as $cateThree)
                                    <a href="{{url('taobao/danh-muc/'.$cate->slug.'/'.$cateTwo->slug.'/'.$cateThree->slug)}}"
            ...
            <div class="box-content-category-right">
                <form @if(!$name && !$slug && $status ) action="{{route('taobao.category',$cate->slug)}}"
                      @elseif($name && !$slug && $status) action="{{url('taobao/danh-muc/'.$cate->slug.'/'.$cateTwo->slug)}}"
                      @else action="{{url('taobao/danh-muc/'.$cate->slug.'/'.$cateTwo->slug.'/'.$cateThree->slug)}}"
                      @endif method="GET">
                    <div class="line-menu-search-category custom-shadow">
                        ...
                        <div class="box-filter-price d-flex align-items-center mx-3 gap-2">
                            ...
                            @if(request()->filled('min_price') || request()->filled('max_price'))
                                <a @if(!$name && !$slug && $status ) href="{{route('taobao.category',$cate->slug)}}"
                                   @elseif($name && !$slug && $status) href="{{url('taobao/danh-muc/'.$cate->slug.'/'.$cateTwo->slug)}}"
                                   @else href="{{url('taobao/danh-muc/'.$cate->slug.'/'.$cateTwo->slug.'/'.$cateThree->slug)}}"
