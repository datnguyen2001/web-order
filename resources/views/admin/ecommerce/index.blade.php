                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a class="btn btn-success"
                                   href="{{route('admin.e-commerce-platform.create')}}">Thêm sàn TMDT</a>
                            </div>
                            <table class="table">
                                <thead class="thead-dark">
                                <tr>
                                    <th scope="col">STT</th>
                                    <th scope="col">Tên sàn</th>
                                ...
                                <tbody>
                                    @foreach($listData as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{url('admin/e-commerce-platform/edit/'.$value->id)}}"
                                                       class="btn btn-icon btn-light btn-hover-success btn-sm"
                                                       data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                       data-bs-original-title="Cập nhật">
                                                        <i class="bi bi-pencil-square "></i>
                                                    </a>
                                                    <a href="{{url('admin/e-commerce-platform/delete/'.$value->id)}}"
