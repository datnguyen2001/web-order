    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <form action="{{url("admin/post/update",$data->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <select name="type" class="form-control">
                                <option value="1" @if($data->type == 1) selected @endif>Chăm sóc khách hàng</option>
                                <option value="2" @if($data->type == 2) selected @endif>Về shop</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-5">
